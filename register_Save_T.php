<?php 
    ...
    if($count == 1){
        $query = "INSERT INTO teachers (idTeacher_T,password_T,name_T,surnameF_T,surnameM_T,email_T,phoneNumber_T) VALUES ('$_POST[idTeacher_T]','$_POST[password_T]','$_POST[name_T]','$_POST[surnameF_T]','$_POST[surnameM_T]','$_POST[email_T]',NULL)";

...
<body class="text-center">
  ...
  <h1 class="display-4">Update for Students</h1>
  <p class="lead">This is the Form of Update for Students of CAI in the Univerity Polytechnic of Victoria.</p>
  </div>  
  ...
  <!--Form-->
    <form action="update_Save_S.php" method="post">

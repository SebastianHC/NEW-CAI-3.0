...
<body class="text-center">
  ...
  <h1 class="display-4">Update for Groups</h1>
  <p class="lead">This is the Form of Update for Groups of CAI in the Univerity Polytechnic of Victoria.</p>
  </div>  
...
<div class="list-group float-right">
  ...
  <!--Form-->
<form action="update_Save_G.php" method="post">

...
<body class="text-center">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
  		<li class="nav-item">
        			<a class="nav-link text-warning" href="indexT.php">Teacher<span class="sr-only">(current)</span></a>
      			</li>
    </ul>
  </div>
</nav>
<!--Log in-->
	<form class="form-signin" method="post" action="validarSU.php">
		...
		<img class="mb-4"src="img/UPV-LOGO.png" width="120" height="120">
		<h1  class="h3 mb-3 font-weight-normal text-dark">Login Super User</h1>

		<label class="sr-only" for="inputUsername">Username</label>
		<input id="inputUsername" class="form-control bg-transparent text-white"placeholder="Username" type="text" name="username_A">
		<label class="sr-only  text-white" for="inputPassword">Password</label>
		<input id="inputPassword" class="form-control bg-transparent text-white" placeholder="Password" type="password" name="password_A">
		<button class="btn btn-lg btn-primary btn-block mt-3 btn-outline-#663399"style="background-color: #663399;" type="submit" name="loginSU">Log In</button>
		<br>

	</form>


<nav class="navbar fixed-bottom navbar-expand-sm navbar-dark bg-#663399" style="background-color: #663399;>

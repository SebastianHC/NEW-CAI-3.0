...
<!--Log in-->
	<form class="form-signin" method="post" action="validarT.php">
		...
		<h1  class="h3 mb-3 font-weight-normal text-dark">Login Teacher</h1>
		...
		<button class="btn btn-lg btn-primary btn-block mt-3 btn-outline-#663399"style="background-color: #663399;" type="submit" name="loginT">Log In</button>
		<br>
